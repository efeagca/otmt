...
export const Projects:Project[]=[
    {id:1, name:"Denemeler", description:"Deneme dedik ya", teamMembers:[{name:"Efe", surname:"Ağca", email:"efe@h.com",password:"1234"}], isPublic:true, taskCount:0,todoTasks:[
    ...
    {id:2, name:"Denemeler 2", description:"Deneme dedik ya gökçin", teamMembers:[{name:"Efe", surname:"Ağca", email:"efe@h.com",password:"1234"}], taskCount:0, isPublic:true, todoTasks:[], doingTasks:[], doneTasks:[
